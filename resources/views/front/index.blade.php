                ...
                <div class="member-thumb"> <img src="images/service-1.jpg" alt="image">
                  <div class="overlay2">
                    <div class="overlay_inner">
                      <a class="btn-icon" data-fancybox="gallery" href="images/service-1.jpg"><i
            ...
            <div class="recent-work-wrap">
              <div class="team-member text-center">
                <div class="member-thumb"> <img src="images/service-7.jpg" alt="image">
                  <div class="overlay2">
                    <div class="overlay_inner">
                      <a class="btn-icon" data-fancybox="gallery" href="images/service-7.jpg"><i
                          class="fa fa-search-plus" aria-hidden="true"></i></a>
                      <a class="btn-icon" href="#"><i class="fa fa-share-square-o" aria-hidden="true"></i></a>
                    </div>
                  </div>
            ...
            <div class="recent-work-wrap">
              <div class="team-member text-center">
                <div class="member-thumb"> <img src="images/service-8.jpg" alt="image">
                  <div class="overlay2">
                    <div class="overlay_inner">
                      <a class="btn-icon" data-fancybox="gallery" href="images/service-8.jpg"><i
                          class="fa fa-search-plus" aria-hidden="true"></i></a>
                      <a class="btn-icon" href="#"><i class="fa fa-share-square-o" aria-hidden="true"></i></a>
                    </div>
                  </div>
        ...
        <div class="property_item bottom40">
          ...
          <div class="proerty_content">
            <div class="proerty_text">
              ...
              <p class="p-font-15">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam power nonummy nibh
      ...
      <div class="col-md-3 col-sm-3 col-xs-12 text-center">
        <div class="team-box">
          ...
          <div class="team-box-overlay">
            <h2>Anita Kutlesa</h2>
            <p>Anita is an Arizona native and has experience with rental real estate investments. She enjoys kombucha &
              classic video games and tennis.</p>
          </div>
